...
if (isset($_POST["signup"])) {
  ...
  if ($password !== $cpassword) {
    ...
    if ($result) {
      ...
      $to = $email;
      $subject = "Email verification - NAPD Online Lecture Management System";
...
<head>
  ...
  <title>Sign in & Sign up Form - OLMS</title>
</head>
    ...
    <div class="panels-container">
      <div class="panel left-panel">
        <div class="content">
          <h3>Hello sir!</h3>
          <p>
            Welcome to NAPD Online Lecture Management System. 
            If you not register yet, please sign up now. 
          </p>
