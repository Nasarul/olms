...
if($_SERVER["REQUEST_METHOD"] == "POST"){
    ...
    if(empty($new_pass_err) && empty($confirm_pass_err)){
        ...
        $sql = "UPDATE tbluser SET pass = ? WHERE id = ?";
    ...
    <div class="wrapper">
        ...
        <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post"> 
            <div class="form-group">
                ...
                <input type="password" name="new_pass" class="form-control <?php echo (!empty($new_pass_err)) ? 'is-invalid' : ''; ?>" value="<?php echo $new_pass; ?>">
                <span class="invalid-feedback"><?php echo $new_pass_err; ?></span>
            </div>
            <div class="form-group">
                <label>Confirm Password</label>
                <input type="password" name="confirm_pass" class="form-control <?php echo (!empty($confirm_pass_err)) ? 'is-invalid' : ''; ?>">
